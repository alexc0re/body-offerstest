...
#        print(modified)
        ...
        for products, prises_list in modified.items():
            ...
            print("=========")
            print("=========")
            #print(f"Price {products} was changed from  {prises_list[0]} to {prises_list[1]}")
            print("=========")
            print("=========")
            print("=========")
